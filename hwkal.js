...
//—————「 Set Nama Own & Bot 」—————//
global.ownername = 'Owner Garuda C2' //ubah jadi nama mu, note tanda ' gausah di hapus!
//=================================================//
global.owner = ['6283150688326'] // ubah aja pake nomor lu
//==========================BY Hw Mods=======================//
global.keyopenai = `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`
//====================BY Hw Mods=============================//
global.botname = 'Bot Bug Zxkys' //ubah jadi nama bot mu, note tanda ' gausah di hapus!
global.packname = 'Memek Gede' // ubah aja ini nama sticker
global.author = 'Zxkys & Garuda C2' // ubah aja ini nama sticker
global.prefa = ['','!','.',',','🐤','🗿']
